...
Tech = Category(id=2, name="Tech", user_id=1)
session.add(Tech)
session.commit()
...
News = Category(id=3, name="News", user_id=1)
session.add(News)
session.commit()
...
Post5 = Post(post="Did you guys see local governemnt?", item_id=5, user_id=1)
session.add(Post5)
session.commit()
...
Post6 = Post(post="War in Syria?", item_id=6, user_id=1)
session.add(Post6)
session.commit()
...
Entertainment = Category(id=4, name="Entertainment", user_id=1)
...
Post7 = Post(post="Harry Potter new realease?", item_id=7, user_id=1)
session.add(Post7)
session.commit()
